#
#  Be sure to run `pod spec lint SwiftyReusableLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SwiftyReusableLib"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SwiftyReusableLib."
  ...
  spec.homepage     = "http://EXAMPLE/SwiftyReusableLib"
  ...
  spec.source       = { :git => "http://EXAMPLE/SwiftyReusableLib.git", :tag => "#{spec.version}" }
